	  ...
	  */
	   ...
	   */
			value: function signup(signupData) {
				...
				if ((0, _isString2.default)(signupDate)) {
	   ...
	   */
			...
			value: function authUsingProvider(provider) {
				...
				return ProviderAuth.signupWithServer(provider).then(function (response) {
					_logger2.default.info({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.signupWithServer = exports.updateUserData = exports.getUserData = exports.logout = exports.login = exports.signup = undefined;
	...
	var signupWithServer = exports.signupWithServer = function () {
		...
		return function signupWithServer(_x5) {
			return ref.apply(this, arguments);
		};
	}();
